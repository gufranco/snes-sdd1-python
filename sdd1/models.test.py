...
class CatalogueTest(unittest.TestCase):
    ...
    def test_a_model_says_what_it_is_and_what_it_interleaves(self):
    ...
    def test_a_model_prints_as_its_name_and_planes(self):
...
class BuildTest(unittest.TestCase):
    ...
    def test_the_default_model_is_the_one_the_cartridges_carry(self):
        self.assertEqual(sdd1.Sdd1().model, "sdd1")

    def test_a_built_chip_decompresses_the_same_way_the_function_does(self):
